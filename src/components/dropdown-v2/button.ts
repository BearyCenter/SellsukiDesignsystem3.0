...
@customElement("ssk-dropdown-button-v2")
export class DropdownButtonV2 extends LitElement {
  static registeredName = "ssk-dropdown-button-v2";
...
declare global {
  interface HTMLElementTagNameMap {
    "ssk-dropdown-button-v2": DropdownButtonV2;
  }
}
