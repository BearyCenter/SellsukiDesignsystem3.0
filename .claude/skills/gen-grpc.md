---
description: Regenerate gRPC Go code from all .proto files. Use when proto files have been modified and the generated stubs need to be updated.
---
...
3. If new RPC methods were added to a proto:
   - Add stub implementations in the corresponding `*_grpc_server.go` file following the existing pattern
