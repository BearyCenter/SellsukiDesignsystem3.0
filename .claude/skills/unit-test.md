---
description: Run all unit tests for the project and report the results. Use after implementing any feature, bug fix, or refactoring to verify correctness. Do not mark work complete until all tests pass.
---
