...
# Mirrors .opencode/plugin/env-protection.ts behavior for Claude Code.
#
# Triggered as a PreToolUse hook on the Read tool.
# Receives tool input JSON on stdin.
# Exit 2 = block the tool call (stderr shown as reason).
